...
public class TestSA extends TCBaseTest {
    ...
    protected void assertImpossibleToAddWeapons() {
        String string = getString(R.string.saNoWeaponPoints);
        ViewInteraction button5 = onView(allOf(withText(startsWith(string.substring(0, string.length() - 4))), isDisplayed()));
