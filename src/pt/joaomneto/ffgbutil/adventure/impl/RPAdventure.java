...
public class RPAdventure extends Adventure {
	...
	public RPAdventure() {
		...
		fragmentConfiguration.put(FRAGMENT_COMBAT, new AdventureFragmentRunner(R.string.fights, "pt.joaomneto.ffgbutil.adventure.impl.fragments.rp.RPAdventureCombatFragment"));
