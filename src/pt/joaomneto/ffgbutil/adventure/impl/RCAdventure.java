...
public class RCAdventure extends TFODAdventure {
    ...
    public RCAdventure() {
        ...
        fragmentConfiguration.put(FRAGMENT_ROBOTS, new AdventureFragmentRunner(R.string.robots, "pt.joaomneto.ffgbutil.adventure.impl.fragments.rc.RCAdventureRobotFragment"));
