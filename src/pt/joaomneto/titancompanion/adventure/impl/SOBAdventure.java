...
public class SOBAdventure extends Adventure {
	...
	public SOBAdventure() {
		...
		fragmentConfiguration.put(FRAGMENT_VITAL_STATS, new AdventureFragmentRunner(R.string.vitalStats, "pt.joaomneto.titancompanion.adventure.impl.fragments.sob.SOBAdventureVitalStatsFragment"));
		...
		fragmentConfiguration.put(FRAGMENT_SHIP_COMBAT, new AdventureFragmentRunner(R.string.shipCombat, "pt.joaomneto.titancompanion.adventure.impl.fragments.sob.SOBShipCombatFragment"));
		...
		fragmentConfiguration.put(FRAGMENT_BOOTY, new AdventureFragmentRunner(R.string.booty, "pt.joaomneto.titancompanion.adventure.impl.fragments.sob.SOBAdventureBootyFragment"));
